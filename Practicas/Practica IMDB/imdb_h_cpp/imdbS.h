...
class const_iterator { 
        ...
        private:
	       friend class imdb;
	       multimap<string, size_type>::iterator pos;
...
*/	 
 ...
 private:
  ...
  multimap<string, size_type> ind_pelicula; // el string representa el nombre de pelicula
  map<string, map<string, size_type> > ind_anio; //la clave del primer map, representa el año, la clave del segundo map (string,size_type) representa el nombre de la pelicula.
